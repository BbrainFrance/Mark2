...
const readHistoryDefinition = {
  ...
  description: 'Lit l\'historique de conversation d\'un autre agent. Utile pour savoir ce qui a ete discute avec un agent specialise. Agents disponibles : jarvis, comptaapp, paybrain, paybrain-app, paybrain-tpe, salesbrain, blockbrain, businessplan-paybrain, tradebrain, swapdf.',
  input_schema: {
    type: 'object',
    properties: {
      agent_id: {
